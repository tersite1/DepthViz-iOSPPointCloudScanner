...
func duplicatePixelBuffer(input: CVPixelBuffer) -> CVPixelBuffer {
    ...
    _ = CVPixelBufferCreate(kCFAllocatorDefault, bufferWidth, bufferHeight, bufferFormat, CVBufferCopyAttachments(input, CVAttachmentMode.shouldPropagate), &copyOut)
    let output = copyOut!
